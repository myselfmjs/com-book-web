...
<script type="text/javascript" src="${ctxStatic}/common/search.js?${fns:random()}"></script>
<script type="text/javascript" src="${ctxStatic}/main/wd_js/inputSkip.js?${fns:random()}"></script>
<script type="text/javascript" src="${ctxStatic}/utils/base64.js"></script>
<script type="text/javascript" src="${ctxStatic}/utils/form.js"></script>
